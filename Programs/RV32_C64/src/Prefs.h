...
public:
	...
	bool ShowEditor(bool startup, const std::string & prefs_path, const std::string & snapshot_path);
	void Check();
	void Load(const std::string & prefs_path);
	bool Save(const std::string & prefs_path);
